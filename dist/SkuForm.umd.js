(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("vue"), require("ElementPlus"));
	else if(typeof define === 'function' && define.amd)
		define([, "ElementPlus"], factory);
	else if(typeof exports === 'object')
		exports["SkuForm"] = factory(require("vue"), require("ElementPlus"));
	else
		root["SkuForm"] = factory(root["Vue"], root["ElementPlus"]);
})((typeof self !== 'undefined' ? self : this), function(__WEBPACK_EXTERNAL_MODULE__9274__, __WEBPACK_EXTERNAL_MODULE__720__) {
...
"use strict";
module.exports = __WEBPACK_EXTERNAL_MODULE__720__;
...
var update = add("7282f4d6", content, true, {"sourceMap":false,"shadowMode":false});
...
;// ./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib/index.js??clonedRuleSet-82.use[1]!./node_modules/vue-loader/dist/templateLoader.js??ruleSet[1].rules[3]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./src/components/SkuForm.vue?vue&type=template&id=eb65c3fe&scoped=true
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (0,external_commonjs_vue_commonjs2_vue_root_Vue_.openBlock)(), (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementBlock)("div", _hoisted_1, [!$props.disabled ? ((0,external_commonjs_vue_commonjs2_vue_root_Vue_.openBlock)(), (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementBlock)("div", _hoisted_2, [$props.theme == 1 ? ((0,external_commonjs_vue_commonjs2_vue_root_Vue_.openBlock)(), (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementBlock)("div", _hoisted_3, [((0,external_commonjs_vue_commonjs2_vue_root_Vue_.openBlock)(true), (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementBlock)(external_commonjs_vue_commonjs2_vue_root_Vue_.Fragment, null, (0,external_commonjs_vue_commonjs2_vue_root_Vue_.renderList)($data.myAttribute, (item, index) => {
    return (0,external_commonjs_vue_commonjs2_vue_root_Vue_.openBlock)(), (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createBlock)(_component_el_card, {
      ...
      header: (0,external_commonjs_vue_commonjs2_vue_root_Vue_.withCtx)(() => [(0,external_commonjs_vue_commonjs2_vue_root_Vue_.createTextVNode)((0,external_commonjs_vue_commonjs2_vue_root_Vue_.toDisplayString)(item.name), 1)]),
      default: (0,external_commonjs_vue_commonjs2_vue_root_Vue_.withCtx)(() => [((0,external_commonjs_vue_commonjs2_vue_root_Vue_.openBlock)(true), (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementBlock)(external_commonjs_vue_commonjs2_vue_root_Vue_.Fragment, null, (0,external_commonjs_vue_commonjs2_vue_root_Vue_.renderList)(item.item, (item2, index2) => {
      ...
      }), 128)), item.canAddAttribute ? ((0,external_commonjs_vue_commonjs2_vue_root_Vue_.openBlock)(), (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createBlock)(_component_el_input, {
        key: 0,
        ...
        placeholder: "新增一个规格",
        class: "add-attr",
        onKeyup: (0,external_commonjs_vue_commonjs2_vue_root_Vue_.withKeys)($event => $options.onAddAttribute(index), ["enter"])
      }, {
        append: (0,external_commonjs_vue_commonjs2_vue_root_Vue_.withCtx)(() => [(0,external_commonjs_vue_commonjs2_vue_root_Vue_.createVNode)(_component_el_button, {
          size: "small",
          onClick: $event => $options.onAddAttribute(index)
        }, {
          default: (0,external_commonjs_vue_commonjs2_vue_root_Vue_.withCtx)(() => [...(_cache[1] || (_cache[1] = [(0,external_commonjs_vue_commonjs2_vue_root_Vue_.createTextVNode)("添加", -1)]))]),
          _: 1
        }, 8, ["onClick"])]),
        _: 2
      }, 1032, ["modelValue", "onUpdate:modelValue", "onKeyup"])) : (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createCommentVNode)("", true)]),
      _: 2
    }, 1024);
  }), 128))])) : ((0,external_commonjs_vue_commonjs2_vue_root_Vue_.openBlock)(), (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createBlock)(_component_el_table, {
    key: 1,
    ...
    default: (0,external_commonjs_vue_commonjs2_vue_root_Vue_.withCtx)(() => [(0,external_commonjs_vue_commonjs2_vue_root_Vue_.createVNode)(_component_el_table_column, {
      ...
      width: "120",
      resizable: false
    }), (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createVNode)(_component_el_table_column, null, {
      default: (0,external_commonjs_vue_commonjs2_vue_root_Vue_.withCtx)(scope => [((0,external_commonjs_vue_commonjs2_vue_root_Vue_.openBlock)(true), (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementBlock)(external_commonjs_vue_commonjs2_vue_root_Vue_.Fragment, null, (0,external_commonjs_vue_commonjs2_vue_root_Vue_.renderList)(scope.row.item, (item2, index2) => {
        return (0,external_commonjs_vue_commonjs2_vue_root_Vue_.openBlock)(), (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createBlock)(_component_el_checkbox, {
          key: index2,
          modelValue: item2.checked,
          "onUpdate:modelValue": $event => item2.checked = $event,
      ...
      _: 1
    }), (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createVNode)(_component_el_table_column, {
      width: "250"
    }, {
      default: (0,external_commonjs_vue_commonjs2_vue_root_Vue_.withCtx)(scope => [(0,external_commonjs_vue_commonjs2_vue_root_Vue_.createVNode)(_component_el_input, {
        modelValue: scope.row.addAttribute,
        "onUpdate:modelValue": $event => scope.row.addAttribute = $event,
        size: "small",
        placeholder: "新增一个规格",
        class: "add-attr",
        onKeyup: (0,external_commonjs_vue_commonjs2_vue_root_Vue_.withKeys)($event => $options.onAddAttribute(scope.$index), ["enter"])
      }, {
        append: (0,external_commonjs_vue_commonjs2_vue_root_Vue_.withCtx)(() => [(0,external_commonjs_vue_commonjs2_vue_root_Vue_.createVNode)(_component_el_button, {
          size: "small",
          onClick: $event => $options.onAddAttribute(scope.$index)
        }, {
          default: (0,external_commonjs_vue_commonjs2_vue_root_Vue_.withCtx)(() => [...(_cache[2] || (_cache[2] = [(0,external_commonjs_vue_commonjs2_vue_root_Vue_.createTextVNode)("添加", -1)]))]),
          _: 1
        }, 8, ["onClick"])]),
        _: 2
    ...
    _: 1
  }, 8, ["data"])), (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementVNode)("div", _hoisted_4, [(0,external_commonjs_vue_commonjs2_vue_root_Vue_.createVNode)(_component_el_input, {
    modelValue: $data.newGroupName,
    "onUpdate:modelValue": _cache[0] || (_cache[0] = $event => $data.newGroupName = $event),
    size: "small",
    placeholder: "新增一个规格组",
    onKeyup: (0,external_commonjs_vue_commonjs2_vue_root_Vue_.withKeys)($options.onAddGroup, ["enter"])
  }, {
    append: (0,external_commonjs_vue_commonjs2_vue_root_Vue_.withCtx)(() => [(0,external_commonjs_vue_commonjs2_vue_root_Vue_.createVNode)(_component_el_button, {
      size: "small",
      onClick: $options.onAddGroup
    }, {
      default: (0,external_commonjs_vue_commonjs2_vue_root_Vue_.withCtx)(() => [...(_cache[3] || (_cache[3] = [(0,external_commonjs_vue_commonjs2_vue_root_Vue_.createTextVNode)("添加组", -1)]))]),
      _: 1
    }, 8, ["onClick"])]),
    _: 1
  }, 8, ["modelValue", "onKeyup"])])])) : (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createCommentVNode)("", true), (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementVNode)("div", _hoisted_5, [(0,external_commonjs_vue_commonjs2_vue_root_Vue_.createVNode)(_component_el_form, {
    ref: "form",
    model: $data.form,
    "status-icon": "",
    "inline-message": ""
    ...
    default: (0,external_commonjs_vue_commonjs2_vue_root_Vue_.withCtx)(() => [(0,external_commonjs_vue_commonjs2_vue_root_Vue_.createVNode)(_component_el_table, {
      ...
      default: (0,external_commonjs_vue_commonjs2_vue_root_Vue_.withCtx)(() => [$options.emitAttribute.length > 0 ? ((0,external_commonjs_vue_commonjs2_vue_root_Vue_.openBlock)(), (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createBlock)(_component_el_table_column, {
        key: 0,
        type: "index",
        width: "50",
        align: "center",
        resizable: false
      })) : (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createCommentVNode)("", true), ((0,external_commonjs_vue_commonjs2_vue_root_Vue_.openBlock)(true), (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementBlock)(external_commonjs_vue_commonjs2_vue_root_Vue_.Fragment, null, (0,external_commonjs_vue_commonjs2_vue_root_Vue_.renderList)($options.emitAttribute, (attr, index) => {
        return (0,external_commonjs_vue_commonjs2_vue_root_Vue_.openBlock)(), (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createBlock)(_component_el_table_column, {
          key: `attribute-${index}`,
          label: attr.name,
          prop: attr.name,
          width: "120",
      ...
      }), 128)), ((0,external_commonjs_vue_commonjs2_vue_root_Vue_.openBlock)(true), (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementBlock)(external_commonjs_vue_commonjs2_vue_root_Vue_.Fragment, null, (0,external_commonjs_vue_commonjs2_vue_root_Vue_.renderList)($props.structure, (item, index) => {
        return (0,external_commonjs_vue_commonjs2_vue_root_Vue_.openBlock)(), (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createBlock)(_component_el_table_column, {
          key: `structure-${index}`,
          label: item.label,
          prop: item.name,
          ...
          header: (0,external_commonjs_vue_commonjs2_vue_root_Vue_.withCtx)(() => [(0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementVNode)("span", {
            class: (0,external_commonjs_vue_commonjs2_vue_root_Vue_.normalizeClass)({
              'required_title': item.required
            })
          }, (0,external_commonjs_vue_commonjs2_vue_root_Vue_.toDisplayString)(item.label), 3), item.tip ? ((0,external_commonjs_vue_commonjs2_vue_root_Vue_.openBlock)(), (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createBlock)(_component_el_tooltip, {
            key: 0,
            effect: "dark",
            content: item.tip,
            placement: "top"
          }, null, 8, ["content"])) : (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createCommentVNode)("", true)]),
          default: (0,external_commonjs_vue_commonjs2_vue_root_Vue_.withCtx)(scope => [item.type == 'input' ? ((0,external_commonjs_vue_commonjs2_vue_root_Vue_.openBlock)(), (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createBlock)(_component_el_form_item, {
            ...
            _: 2
          }, 1032, ["prop", "rules"])) : item.type == 'slot' ? ((0,external_commonjs_vue_commonjs2_vue_root_Vue_.openBlock)(), (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createBlock)(_component_el_form_item, {
            key: `structure-input-${index}-${scope.row.sku}`,
            prop: 'skuData.' + scope.$index + '.' + item.name,
            rules: $options.rules[item.name]
          }, {
            default: (0,external_commonjs_vue_commonjs2_vue_root_Vue_.withCtx)(() => [(0,external_commonjs_vue_commonjs2_vue_root_Vue_.renderSlot)(_ctx.$slots, item.name, {
              index: scope.$index,
              row: scope.row,
              column: scope.column
            }, undefined, true)]),
            _: 2
          }, 1032, ["prop", "rules"])) : (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createCommentVNode)("", true)]),
          _: 2
        }, 1032, ["label", "prop"]);
      }), 128))]),
      _: 2
      ...
      name: "append",
      fn: (0,external_commonjs_vue_commonjs2_vue_root_Vue_.withCtx)(() => [(0,external_commonjs_vue_commonjs2_vue_root_Vue_.createVNode)(_component_el_table, {
        data: [{}],
        "show-header": false
      }, {
        default: (0,external_commonjs_vue_commonjs2_vue_root_Vue_.withCtx)(() => [(0,external_commonjs_vue_commonjs2_vue_root_Vue_.createVNode)(_component_el_table_column, {
          ...
          default: (0,external_commonjs_vue_commonjs2_vue_root_Vue_.withCtx)(() => [...(_cache[4] || (_cache[4] = [(0,external_commonjs_vue_commonjs2_vue_root_Vue_.createTextVNode)("批量设置", -1)]))]),
          _: 1
        }, 8, ["width"]), ((0,external_commonjs_vue_commonjs2_vue_root_Vue_.openBlock)(true), (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createElementBlock)(external_commonjs_vue_commonjs2_vue_root_Vue_.Fragment, null, (0,external_commonjs_vue_commonjs2_vue_root_Vue_.renderList)($props.structure, (item, index) => {
          return (0,external_commonjs_vue_commonjs2_vue_root_Vue_.openBlock)(), (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createBlock)(_component_el_table_column, {
            ...
            default: (0,external_commonjs_vue_commonjs2_vue_root_Vue_.withCtx)(() => [item.type == 'input' && item.batch != false ? ((0,external_commonjs_vue_commonjs2_vue_root_Vue_.openBlock)(), (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createBlock)(_component_el_input, {
              key: 0,
              modelValue: $data.batch[item.name],
              "onUpdate:modelValue": $event => $data.batch[item.name] = $event,
              placeholder: `填写一个${item.label}`,
              size: "small",
              onKeyup: (0,external_commonjs_vue_commonjs2_vue_root_Vue_.withKeys)($event => $options.onBatchSet(item.name), ["enter"])
            }, null, 8, ["modelValue", "onUpdate:modelValue", "placeholder", "onKeyup"])) : (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createCommentVNode)("", true)]),
            _: 2
          }, 1024);
        }), 128))]),
        _: 1
...
var external_ElementPlus_ = __webpack_require__(720);
;// ./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib/index.js??clonedRuleSet-82.use[1]!./node_modules/vue-loader/dist/index.js??ruleSet[0].use[0]!./src/components/SkuForm.vue?vue&type=script&lang=js
      ...
      if (this.myAttribute[index].addAttribute !== '') {
        if (!this.myAttribute[index].addAttribute.includes(this.separator)) {
          ...
          if (!flag) {
            ...
            (0,external_ElementPlus_.ElMessage)({
              type: 'warning',
              message: '请勿添加相同规格'
            });
          }
    ...
    onAddGroup() {
      ...
      if (this.newGroupName !== '') {
        if (!this.newGroupName.includes(this.separator)) {
          ...
          (0,external_ElementPlus_.ElMessage)({
            type: 'warning',
            message: `规格组里不允许出现「 ${this.separator} 」字符，请检查后重新添加`
          });
        }
      }
    },
...
var SkuFormvue_type_style_index_0_id_eb65c3fe_lang_scss_scoped_true = __webpack_require__(1440);
...
const registerElementPlus = app => {
  const hasNamed = external_ElementPlus_.ElButton && external_ElementPlus_.ElTable && external_ElementPlus_.ElForm && external_ElementPlus_.ElCard && external_ElementPlus_.ElCheckbox && external_ElementPlus_.ElInput && external_ElementPlus_.ElTableColumn && external_ElementPlus_.ElTooltip && external_ElementPlus_.ElFormItem;
  if (hasNamed) {
    app.use(external_ElementPlus_.ElCard);
    app.use(external_ElementPlus_.ElCheckbox);
    app.use(external_ElementPlus_.ElInput);
    app.use(external_ElementPlus_.ElButton);
    app.use(external_ElementPlus_.ElTable);
    app.use(external_ElementPlus_.ElTableColumn);
    app.use(external_ElementPlus_.ElTooltip);
    app.use(external_ElementPlus_.ElForm);
    app.use(external_ElementPlus_.ElFormItem);
...
const createAppWithSkuForm = (options = {}) => {
  const app = (0,external_commonjs_vue_commonjs2_vue_root_Vue_.createApp)(options);
  registerElementPlus(app);
  app.component(SkuForm.name, SkuForm);
  return app;
};
...
//# sourceMappingURL=SkuForm.umd.js.map